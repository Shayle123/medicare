    ...
    <div className="bg-[#f5f7fa] min-h-screen text-gray-800">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8">
              <div className="flex justify-between">
                ...
                <span className="text-teal-400 font-bold">+8.2%</span>
              </div>

              <h2 className="text-5xl font-black mt-8">12,847</h2>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8">
              <div className="flex justify-between">
                ...
                <span className="text-cyan-400 font-bold">+12 new</span>
              </div>

              <h2 className="text-5xl font-black mt-8">284</h2>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8">
              ...
              <h2 className="text-5xl font-black mt-8">78%</h2>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8">
              ...
              <h2 className="text-5xl font-black mt-8">43</h2>
      ...
      <section className="bg-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-4 gap-10 text-center">
          ...
          <div>
            <h2 className="text-5xl font-black">50,000+</h2>
            <p className="mt-3 text-lg">Patients Managed</p>
          </div>

          <div>
            <h2 className="text-5xl font-black">1,200+</h2>
            <p className="mt-3 text-lg">Doctors Connected</p>
          </div>

          <div>
            <h2 className="text-5xl font-black">300+</h2>
